...
<?php if(!empty($header_image) || (!empty($header_color) && $header_color['primary'] != ' ' && $header_color['secondary'] != ' ') || !empty($header_pattern) || !empty($text_color)): ?>
    ...
    ?>
        ...
        <?php if(!empty($text_color)):?>
            #content.a #pricing.va .heading-a,
            #content.a #pricing.va .heading-a h3,
            #content.a #pricing.va .heading-a h3 .small,
            #content.a #pricing.va .list-c > li > span,
            #content.a #pricing.va .list-c li span span,
            #content.a #pricing.va .list-c > li > ul li,
            #content.a #pricing.va .list-c li a
            {
                color: <?php echo $text_color; ?>;
            }
            #content.a #pricing.va .heading-a h3:before
            {
