            ...
            'settings' => array(
                ...
                'options' => array(
                    'header_portf_post_color' => array(
                        ...
                        'value' => fw_get_db_settings_option('header_portf_post_color')
                    ),
                    ...
                    'header_portf_post_image' => array(
                        ...
                        'type'  => 'upload',
                        'value' => fw_get_db_settings_option('header_portf_post_image')
                    ),
                    ...
                    'header_portf_post_pattern' => array(
                        ...
                        'type'  => 'upload',
                        'value' => fw_get_db_settings_option('header_portf_post_pattern')
                    ),
                    ...
                    'header_portf_post_title' => array(
                        ...
                        'type'  => 'text',
                        'value' => fw_get_db_settings_option('header_portf_post_title')
                    )
                ),
            ),
        ),
